...
LABEL version="0.0.1"
LABEL repository="https://github.com/advancedcsg/action-ccq"
LABEL homepage="https://github.com/advancedcsg/action-ccq"
LABEL maintainer="Advanced Toolchain"
LABEL "com.github.actions.name"="SonarQube Scan"
LABEL "com.github.actions.description"="Scan your code with SonarQube to detect bugs, vulnerabilities and code smells."
...
RUN wget -U "action-ccq" -q -O sonar-scanner-cli.zip https://binaries.sonarsource.com/Distribution/sonar-scanner-cli/sonar-scanner-cli-${SONAR_SCANNER_VERSION}.zip \
